...
high_performing_products AS (
    ...
    WHERE pr.average_rating >= COALESCE(:min_average_rating, (SELECT avg_rating FROM average_values))
      AND ps.total_sales >= COALESCE(:min_total_sales, (SELECT avg_sales FROM average_values))
